      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
            Get In <span className="text-emerald-600 animate-gradient">Touch</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white group hover:scale-105 transition-all duration-300 hover:shadow-lg"
              >
          ...
          >
                ...
                return (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-600 transition-colors duration-300 group-hover:scale-110">
                        <Icon className="w-6 h-6 text-emerald-600 group-hover:text-white transition-colors duration-300" />
                      </div>
                      <div className="flex-1">
                        <h4 className="text-lg font-semibold text-slate-900 mb-2 group-hover:text-emerald-600 transition-colors duration-300">
                          {info.title}
                        </h4>
            ...
            <Card className="p-6 bg-emerald-50 border-emerald-200 hover:shadow-lg hover:scale-105 transition-all duration-300 group">
              <div className="flex items-center space-x-3 mb-3">
                <div className="w-10 h-10 bg-emerald-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              ...
              <p className="text-emerald-700 font-semibold text-lg">+91 9947004671</p>
            </Card>
          </div>
        </div>
        ...
        >
          ...
          <Button
            size="lg"
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 hover:scale-110 hover:shadow-xl transition-all duration-300"
            onClick={() => {
