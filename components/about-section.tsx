      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
            About <span className="text-emerald-600 animate-gradient">Sankalpa Builders</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <div className="space-y-4">
              ...
              <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <h4 className="text-lg font-semibold text-emerald-800">Government Recognition</h4>
                </div>
            ...
            <Button className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3">Learn More About Us</Button>
          </div>
          ...
          >
            ...
            <Card className="absolute -bottom-6 -left-6 bg-white p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 rounded-full">
              <div className="text-center">
                <div className="text-3xl font-bold text-emerald-600 mb-1 animate-number-count">17+</div>
            ...
            return (
              ...
              >
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-emerald-600 transition-colors duration-300">
                  <Icon className="w-8 h-8 text-emerald-600 group-hover:text-white transition-colors duration-300 group-hover:scale-110" />
                </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              >
                <div className="w-12 h-12 bg-emerald-600 rounded-full flex items-center justify-center mx-auto group-hover:bg-emerald-700 transition-colors duration-300 group-hover:scale-110">
                  <span className="text-white font-bold text-lg">{value.letter}</span>
                </div>
                <h4 className="text-lg font-semibold text-slate-900 group-hover:text-emerald-600 transition-colors duration-300">
                  {value.title}
                </h4>
